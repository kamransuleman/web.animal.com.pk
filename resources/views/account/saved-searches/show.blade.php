        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 page-content">
                    <div class="inner-box">
                        <h2 class="title-2"><i class="fas fa-bell"></i> {{ t('Saved search') }}
                            #{{ data_get($savedSearch, 'id') }} </h2>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-8 add-desc-box">
                                                        <div class="items-details">
                                                            <h5 class="add-title">
                                                                <a
                                                                    href="{{ \App\Helpers\UrlGen::post($post) }}">{{ data_get($post, 'title') }}</a>
                                                            </h5>
